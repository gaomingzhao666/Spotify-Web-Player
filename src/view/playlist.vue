<template>
	<div class="playlist">
		<div class="listInfo">
			<img :src="data.imgURL" :title="data.listTitle" />
			<div class="info">
				<p>歌单</p>
		...
		<div class="controlBar">
			<div class="left">
				...
				<img
					...
					class="heart"
				/>
				<el-icon size="22" color="darkgrey" class="delete"><Delete /></el-icon>
			</div>
			...
			<div class="right">
				...
				>
					<template #reference>
						<el-icon size="22" color="darkgrey"><QuestionFilled /></el-icon>
					</template>
				</el-popover>
				<input
					type="text"
		...
		<div class="tableList">
			...
			></vTable>
			<p style="text-align: center; margin-top: 100px" v-else>
...
const filterSong = () => {
	...
	data.searchRes = data.songsList.filter((item) =>
		item.name.includes(data.keywords)
	)
}
const inputing = ref()
