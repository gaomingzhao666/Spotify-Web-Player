<template>
	<div class="login">
		<div class="logo">
			<img src="../../../logo.svg" title="Spotify" width="77" class="spotify" />
		...
		<el-input
			...
			size="large"
		/>
		<el-button round text @click="useGetCode" :disabled="btnDisabled">{{
			btnText
		}}</el-button>
		<el-button type="success" round @click="useLogin">点击此处登录</el-button>
		<router-link to="/loginQRcode" class="tips"
